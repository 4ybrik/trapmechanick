...
### Test case 2:
    1.Зайти на https://www.holiday.by/tours
    2.В ценовом фильтре выбрать от 300 BYN до 500 BYN
    3.В календаре выбрать от 10.08.2021 до 11.08.2021
    Результат: ничего не выведется (выведется сообщение, о том что ничего не найдено).
***
### Test case 3:
    1.Зайти на https://www.holiday.by/tours
